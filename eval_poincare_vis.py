...
for j in [2]:
    ...
    M = np.loadtxt(f'poincare/output_well_False_lengthbound_24_0_kap_5_0_msc_5_0_dist_0_1_fil_0_ig_5_order_16__poincare_{j}.txt', delimiter=',', skiprows=1)
    ...
    for i in range(n):
        ...
        plt.scatter(r, list(M[:, 2*i+1]), s=2.0, c="r", marker='o', linewidths=0)
